...
def game():
    ...
    global button_1_1
    button_1_1 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(1, 1, row_column_values))
    button_1_1.grid(row = 1, column = 1, padx = 1, pady = 1)

    global button_1_2
    button_1_2 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(1, 2, row_column_values))
    button_1_2.grid(row = 1, column = 2, padx = 1, pady = 1)

    global button_1_3
    button_1_3 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(1, 3, row_column_values))
    button_1_3.grid(row = 1, column = 3, padx = 1, pady = 1)

    global button_2_1
    button_2_1 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(2, 1, row_column_values))
    button_2_1.grid(row = 2, column = 1, padx = 1, pady = 1)

    global button_2_2
    button_2_2 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(2, 2, row_column_values))
    button_2_2.grid(row = 2, column = 2, padx = 1, pady = 1)

    global button_2_3
    button_2_3 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(2, 3, row_column_values))
    button_2_3.grid(row = 2, column = 3, padx = 1, pady = 1)

    global button_3_1
    button_3_1 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(3, 1, row_column_values))
    button_3_1.grid(row = 3, column = 1, padx = 1, pady = 1)

    global button_3_2
    button_3_2 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(3, 2, row_column_values))
    button_3_2.grid(row = 3, column = 2, padx = 1, pady = 1)

    global button_3_3
    button_3_3 = Button(root, height = 7,  width = 15, borderwidth = 2, command = lambda: game_algorithm(3, 3, row_column_values))
